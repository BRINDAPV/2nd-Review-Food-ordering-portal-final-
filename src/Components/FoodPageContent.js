...
const FoodList = () => {
  ...
  const handleOnClick=(id,foodName,imageUrl,Restaurant,available,price)=>{
    console.log("Clicked",id);
    setClickedCard(id);
    
    history.push(`/nextfile/${id}`);

    const isFoodSelected = selectedFoods.find((food) => food.id === id);

    if (!isFoodSelected) {
      setSelectedFoods((prevSelectedFoods) => [
        ...prevSelectedFoods,
        { id, foodName, available, price, imageUrl, Restaurant },
      ]);
    }
  };
  ...
  const foodItems = [
    ...
    { id: 1,available:'Yes',Restaurant:"HariBhavanam", price : '203', foodName: 'Kosha Mangsho',Cuisine:'Cuisine : West Bengal' ,imageUrl: 'https://s3-ap-south-1.amazonaws.com/betterbutterbucket-silver/devshri-chatterji20180128134028494.jpeg' },
    { id: 2,available:'Yes', price : '190' ,foodName: 'Misal Pav',Cuisine:'Cuisine : Maharastra' ,imageUrl: 'https://www.secondrecipe.com/wp-content/uploads/2021/05/misal-pav-2021.jpg' },
    { id: 3,available:'Yes', price : '167' ,foodName: 'Bamboo shoots fry',Cuisine:'Cuisine : Assam' ,imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTKItkJn9cYWUWsUxAgsOs7XB6jCk3eFzpLQ&usqp=CAU' },
    { id: 4,available:'Yes', price : '90' ,foodName: 'Veg Thali',Cuisine:'Cuisine : Tamil Nadu' ,imageUrl: 'https://media.istockphoto.com/id/483405040/photo/south-indian-meals-on-banana-leaf.jpg?s=612x612&w=0&k=20&c=WUFvAWQgxT44QW1JHS5c_QiB_RDf2hkR2hf4Kpk_lzA=' },
    { id: 5,available:'No', price : '230', foodName: 'Kodi Pulao',Cuisine:'Cuisine : Andhra Pradesh ' ,imageUrl: 'https://b.zmtcdn.com/data/pictures/chains/5/19439485/6a73ae991b5996015c9bc3153ddef084.jpg?fit=around|960:500&crop=960:500;*,*' },
    { id: 6,available:'yes', price : '298', foodName: 'Hyderabadi Biryani',Cuisine:'Cuisine : Telangana' ,imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiwG6hELXSeWHEQzcoeDGmWz0Z1v0Z_HdLkQ&usqp=CAU' },
    { id: 7,available:'No', price : '86', foodName: 'Poha',Cuisine:'Cuisine : Madhya Pradesh ' ,imageUrl: 'https://www.theloveofspice.com/wp-content/uploads/2019/01/kanda-poha-recipe.jpg' },
    { id: 8,available:'No', price : '87',foodName: 'Bisi Bele Bath',Cuisine:'Cuisine : Karnataka' ,imageUrl: 'https://maayeka.com/wp-content/uploads/2019/12/bisi-bele-bhath.jpg' },
    { id: 9,available:'No', price : '130', foodName: 'Makke di Roti and Sarso da Saag',Cuisine:'Cuisine : Punjab' ,imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJBvlDO8zSlhkoVqeASRvFt-lEXl3WqQxDwg&usqp=CAU' }
  ];
